...
import com.example.hwanginkiu.inkiumovienight.data.entities.GenreData
...
import com.example.hwanginkiu.inkiumovienight.domain.entities.VideoEntity
import com.example.hwanginkiu.inkiumovienight.test.TestsUtils.Companion.getMockedMovieData
...
class DataMappersTests {
    ...
    fun testMappingDetailDataToMovieEntityReturnsExpectedResult() {
        ...
        val videoResult = VideoResult(videos)
        ...
        val reviewsResult = ReviewResult(
                reviews
        )
    ...
    fun testMappingMovieEntityToMovieReturnsExpectedResult() {
        ...
        val movieEntityDataMapper = MovieEntityMovieDataMapper()
